...
export default defineComponent({
  setup() {
    ...
    const initSceneBg = () => {
      ...
      const sky = new URL('../../assets/images/sky.png', import.meta.url).href
    ...
    const initSphereModal = () => {
      //材质
      const earth = new URL('../../assets/images/earth_bg.png', import.meta.url).href
    ...
    const initSceneStar = (initZposition: number): any => {
      ...
      const textureLoader = new THREE.TextureLoader()
      const SF1 = new URL('../../assets/images/starflake1.png', import.meta.url).href
      const SF2 = new URL('../../assets/images/starflake2.png', import.meta.url).href
      const sprite1 = textureLoader.load(SF1)
      const sprite2 = textureLoader.load(SF2)
      parameters = [
